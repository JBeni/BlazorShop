...
{
    /// <summary>
    /// Tests for <see cref="UpdateSubscriberStatusCommandHandler"/> class.
    /// </summary>
    public class UpdateSubscriberStatusCommandHandlerTests : IDisposable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSubscriberStatusCommandHandlerTests"/> class.
        /// </summary>
        public UpdateSubscriberStatusCommandHandlerTests()
        {
        }

        /// <summary>
        /// Gets the <see cref="UpdateSubscriberStatusCommandHandler"/> instance to use.
        /// </summary>
        private UpdateSubscriberStatusCommandHandler SUT { get; }
        ...
        /// <summary>
        /// Gets the <see cref="ILogger{UpdateSubscriberStatusCommandHandler}"/> under test.
        /// </summary>
        private ILogger<UpdateSubscriberStatusCommandHandler> Logger { get; }

        /// <summary>
        /// A test for <see cref="UpdateSubscriberStatusCommandHandler.Handle(UpdateSubscriberStatusCommand, CancellationToken)"/> method.
        /// </summary>
