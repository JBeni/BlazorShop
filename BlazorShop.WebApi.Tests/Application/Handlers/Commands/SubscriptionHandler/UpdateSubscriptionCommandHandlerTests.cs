...
{
    /// <summary>
    /// Tests for <see cref="UpdateSubscriptionCommandHandler"/> class.
    /// </summary>
    public class UpdateSubscriptionCommandHandlerTests : IDisposable
    {
        ...
        /// <summary>
        /// Gets the <see cref="UpdateSubscriptionCommandHandler"/> instance to use.
        /// </summary>
        private UpdateSubscriptionCommandHandler SUT { get; }
        ...
        /// <summary>
        /// Gets the <see cref="ILogger{UpdateSubscriptionCommandHandler}"/> under test.
        /// </summary>
        private ILogger<UpdateSubscriptionCommandHandler> Logger { get; }

        /// <summary>
        /// A test for <see cref="UpdateSubscriptionCommandHandler.Handle(UpdateSubscriptionCommand, CancellationToken)"/> method.
        /// </summary>
