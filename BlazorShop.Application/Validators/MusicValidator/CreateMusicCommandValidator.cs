// <copyright file="CreateMusicCommandValidator.cs" company="Beniamin Jitca" author="Beniamin Jitca">
...
{
    /// <summary>
    /// An implementation of the <see cref="AbstractValidator{CreateMusicCommand}"/>.
    /// </summary>
    public class CreateMusicCommandValidator : AbstractValidator<CreateMusicCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMusicCommandValidator"/> class.
        /// </summary>
        /// <param name="context">Gets An instance of <see cref="IApplicationDbContext"/>.</param>
        public CreateMusicCommandValidator(IApplicationDbContext context)
        {
